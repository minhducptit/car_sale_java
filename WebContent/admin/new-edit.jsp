		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					...
					<h1 class="page-header" style="padding-right: 600px">News Edit</h1>
					<p>
						<br>
					</p>
				</div>
				<div class="col-lg-7" style="padding-bottom: 120px">
					<form action="new-update" method="POST">
						...
						<br> <input type="submit" class="btn btn-default" value="Update news" name="submit" /> <input
